 ...
 */
public class daybyday extends javax.swing.JFrame {

    /**
     * Creates new form daybyday
     */
    ResultSet rs;
...
private void panels(){
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(dtp1, javax.swing.GroupLayout.PREFERRED_SIZE, 298, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        dialog.setSelectedFile(new File("Sold items Day by Day Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select itemid,itemname,customername,address,quantity,price,total from itemselling where dates='"+dps+"'";
                ...
                myDocument.add(new Paragraph("Sold Items Day by Day List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                ...
                table.addCell(new PdfPCell(new Paragraph("Item ID",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Customer Name",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Address",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Quantity",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Price",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Total",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));
                table.addCell(new PdfPCell(new Paragraph("Date",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.RED))));                
//table.addCell(cell);
                while(rs.next())
                {
...
JOptionPane.showMessageDialog(null, e);
 ...
 SimpleDateFormat dateFormatss = new SimpleDateFormat("YYY-MMM-DDD");
String dps = dateFormatss.format(this.dtp1.getDate());
        String sql ="select * from itemselling where dates='"+dps+"'";
 ps = con.prepareStatement(sql);
 rs = ps.executeQuery();
jTable1.setModel(DbUtils.resultSetToTableModel(rs));
...
String dps = dateFormatss.format(this.dtp1.getDate());
                ...
                String sql ="select sum(total) from itemselling where dates='"+dps+"'";
...
SimpleDateFormat dateFormatss = new SimpleDateFormat("YYY-MMM-DDD");
String dps = dateFormatss.format(this.dtp1.getDate());
              String sql ="select sum(quantity) from itemselling where dates='"+dps+"' ";
...
this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(daybyday.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
