...
public class customers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnedit.setText("Edit Selected Customer");
        ...
        btnremove.setText("Remove Selected Customer");
      ...
      private void filter(){
            try{
               // SimpleDateFormat dateFormatss = new SimpleDateFormat("YYY-MMM-DDD");
                ...
                String sql ="select * from customers where customername like'%"+txtsearch.getText()+"%'";
...
int row = this.jTable1.getSelectedRow();
        String sql = "delete from customers where customerid ='"+ jTable1.getModel().getValueAt(row,0).toString()+"'";
try{
