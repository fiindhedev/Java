...
public class itemreport extends javax.swing.JFrame {
    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        dialog.setSelectedFile(new File("items Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select * from items where dates between '"+dps+"' and '"+dps1+"'";
                ...
                myDocument.add(new Paragraph("Items List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("                                     "));

                PdfPCell cells = new PdfPCell(new Paragraph("ITEMS",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cells.setColspan(7);
                ...
                table.addCell(new PdfPCell(new Paragraph("Item Name",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Vendor",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                while(rs.next())
                {
                    ...
                    String addd= rs.getString("vendor") ;
        ...
        */
        ...
        private void avrgexam(){
            ...
            try{
                ...
                String dps = dateFormatss.format(this.dtp1.getDate());
                String dps1 = dateFormatss.format(this.dtp2.getDate());
                String sql ="select sum(total) from items where dates between '"+dps+"' and '"+dps1+"'";
...
String dps = dateFormatss.format(this.dtp1.getDate());
  String dps1 = dateFormatss.format(this.dtp2.getDate());
              String sql ="select sum(quantity) from items where dates between '"+dps+"' and '"+dps1+"' ";
