...
public class custpayreport extends javax.swing.JFrame {

    /**
     * Creates new form custpayreport
     */
    Connection con= connection.dbcon();
    PreparedStatement ps;
    ResultSet rs;
    public custpayreport() {
        initComponents();
          setTitle("Liability Pay Report");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Customers Quantity");
        ...
        jLabel4.setText("CUSTOMERS PAY REPORT");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(15, 15, 15)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(dtp2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        dialog.setSelectedFile(new File("Customers pay Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select * from customerpay where dates between '"+dps+"' and '"+dps1+"'";
                ...
                myDocument.add(new Paragraph("Customers pay List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("                                     "));

                PdfPCell cells = new PdfPCell(new Paragraph("Customers Pay",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cells.setColspan(7);
                ...
                table.addCell(new PdfPCell(new Paragraph("Cust ID",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Cust Name",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Gender",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                table.addCell(new PdfPCell(new Paragraph("Liability Amount",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Amount Paid",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                myDocument.add(new Paragraph("                                     "));
                myDocument.add(new Paragraph("         Signature :______________________                            "));
        ...
        */
        ...
        private void avrgexam(){
            ...
            try{
                ...
                String dps = dateFormatss.format(this.dtp1.getDate());
                String dps1 = dateFormatss.format(this.dtp2.getDate());
                String sql ="select sum(amount) from customerpay where dates between '"+dps+"' and '"+dps1+"'";
...
String dps = dateFormatss.format(this.dtp1.getDate());
  String dps1 = dateFormatss.format(this.dtp2.getDate());
              String sql ="select count(custid) from customerpay where dates between '"+dps+"' and '"+dps1+"' ";
...
this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(custpayreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new custpayreport().setVisible(true);
            }
        });
    }
