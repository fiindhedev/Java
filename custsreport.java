...
public class custsreport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TOTAL Liability");
        ...
        jLabel4.setText("CUSTOMERS REPORT");
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
               ...
               String dps1 = dateFormatss.format(this.dtp2.getDate());
                //ps.setString(5,dps);
               String sql ="select * from customers where dates between '"+dps+"' and '"+dps1+"'";
                ...
                table.addCell(new PdfPCell(new Paragraph("Address",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                 table.addCell(new PdfPCell(new Paragraph("Liability",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                while(rs.next())
                {
                    ...
                    String ids= rs.getString("customerid") ;
                    table.addCell(new PdfPCell(new Phrase(ids)));
...
String dps2 = dateFormatss.format(this.dtp2.getDate());
              String sql ="select count(customerid) from customers where dates between '"+dps+"' and '"+dps2+"' ";
        ...
        */
        ...
        private void avrgexam(){
           ...
           SimpleDateFormat dateFormatss = new SimpleDateFormat("YYY-MMM-DDD");
                String dps = dateFormatss.format(this.dtp1.getDate());
                String dps1 = dateFormatss.format(this.dtp2.getDate());
                String sql ="select sum(liability) from customers where dates between '"+dps+"' and '"+dps1+"'";
