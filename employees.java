     ...
     private void filter(){
            try{
               // SimpleDateFormat dateFormatss = new SimpleDateFormat("YYY-MMM-DDD");
                ...
                String sql ="select * from employees where employeename like'%"+txtsearch.getText()+"%'";
...
JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        btnedit.setText("Edit Selected Employee");
        ...
        btnremove.setText("Remove Selected Employee");
...
Date date = new SimpleDateFormat("YYY-MMM-DDD").parse((String)jTable1.getModel().getValueAt(row, 4));
            frm.dtp1.setDate(date);
Date dates = new SimpleDateFormat("YYY-MMM-DDD").parse((String)jTable1.getModel().getValueAt(row, 5));
            frm.dtp2.setDate(dates);
            frm.txtsalary.setText(jTable1.getModel().getValueAt(row,6).toString());
            frm.cmbwork.setSelectedItem(jTable1.getModel().getValueAt(row,7).toString());
Date datess = new SimpleDateFormat("YYY-MMM-DDD").parse((String)jTable1.getModel().getValueAt(row, 8));
...
frm.setVisible(true);
  ...
  int row = this.jTable1.getSelectedRow();
        String sql = "delete from employees where employeeid ='"+ jTable1.getModel().getValueAt(row,0).toString()+"'";
try{
