 ...
 */
public class vendorsreport extends javax.swing.JFrame {

    /**
     * Creates new form vendorsreport
     */
      ResultSet rs;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Vendors Quantity");
        ...
        jLabel4.setText("VENDORS PAY REPORT");
    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        dialog.setSelectedFile(new File("Vendors pay Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select * from vendorpay where dates between '"+dps+"' and '"+dps1+"'";
                ...
                myDocument.add(new Paragraph("Vendors pay List",FontFactory.getFont(FontFactory.TIMES_BOLD,20,Font.BOLD )));
                myDocument.add(new Paragraph(new Date().toString()));
                myDocument.add(new Paragraph("                                     "));

                PdfPCell cells = new PdfPCell(new Paragraph("Vendors Pay",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cells.setColspan(7);
                ...
                table.addCell(new PdfPCell(new Paragraph("Vendor ID",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Vendor Name",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                table.addCell(new PdfPCell(new Paragraph("Debt Amount",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
...
String dps = dateFormatss.format(this.dtp1.getDate());
  String dps1 = dateFormatss.format(this.dtp2.getDate());
              String sql ="select count(vendorid) from vendorpay where dates between '"+dps+"' and '"+dps1+"' ";
        ...
        private void avrgexam(){
            ...
            try{
                ...
                String dps = dateFormatss.format(this.dtp1.getDate());
                String dps1 = dateFormatss.format(this.dtp2.getDate());
                String sql ="select sum(amountpaid) from vendorpay where dates between '"+dps+"' and '"+dps1+"'";
...
this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vendorsreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vendorsreport().setVisible(true);
            }
        });
    }
