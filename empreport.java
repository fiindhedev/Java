    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select * from employees where dates between '"+dps+"' and '"+dps1+"'";
                ...
                PdfPCell cells = new PdfPCell(new Paragraph("Employees",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cells.setColspan(7);
                ...
                table.addCell(new PdfPCell(new Paragraph("Cotntract Start",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("Contract End",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                while(rs.next())
                {
                    ...
                    String ids= rs.getString("employeeid") ;
                    table.addCell(new PdfPCell(new Phrase(ids)));

                    String cust= rs.getString("employeename") ;
                    ...
                    String costs= rs.getString("contarctstart") ;
                    table.addCell(new PdfPCell(new Phrase(costs)));

                    String tt= rs.getString("contarctend") ;
                    table.addCell(new PdfPCell(new Phrase(tt)));

                    String dts= rs.getString("salary") ;
                    table.addCell(new PdfPCell(new Phrase(dts)));
                    
                    String wkr= rs.getString("wokrtime") ;
                    table.addCell(new PdfPCell(new Phrase(wkr)));
                ...
                /// TABLE LABAAD
                PdfPCell cellss = new PdfPCell(new Paragraph("Employee RESULT",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cellss.setColspan(7);
        ...
        */
        ...
        private void counts(){
            ...
            try{
                ...
                String dps = dateFormatss.format(this.dtp1.getDate());
                String dps1 = dateFormatss.format(this.dtp2.getDate());
                String sql ="select count(empid) from employees where dates between '"+dps+"' and '"+dps1+"'";
