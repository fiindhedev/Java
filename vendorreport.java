...
public class vendorreport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("VENDORS REPORT");
    ...
    private void btnreportMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnreportMouseClicked
        ...
        dialog.setSelectedFile(new File("Vendors Report.pdf"));
        ...
        if (dialogResult==JFileChooser.APPROVE_OPTION){
            ...
            try {
                ...
                //ps.setString(5,dps);
                String sql ="select * from vendors where dates between '"+dps+"' and '"+dps1+"'";
                ...
                PdfPCell cells = new PdfPCell(new Paragraph("Customers List",FontFactory.getFont(FontFactory.TIMES_ROMAN,16,Font.BOLD,BaseColor.WHITE)));
                cells.setColspan(7);
                ...
                table.addCell(new PdfPCell(new Paragraph("Location",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                ...
                table.addCell(new PdfPCell(new Paragraph("Start Date",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
                table.addCell(new PdfPCell(new Paragraph("End Date",FontFactory.getFont(FontFactory.TIMES_ROMAN,14,Font.BOLD,BaseColor.BLACK))));
...
String dps = dateFormatss.format(this.dtp1.getDate());
  String dps1 = dateFormatss.format(this.dtp2.getDate());
              String sql ="select count(vendorid) from vendors where dates between '"+dps+"' and '"+dps1+"' ";
